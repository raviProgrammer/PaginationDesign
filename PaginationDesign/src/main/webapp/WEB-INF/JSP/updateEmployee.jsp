...
<div id="divMain">
	<form:form  method="POST" action="edit" modelAttribute="empData">
	<div class="form"><b>Id*&nbsp;&nbsp;</b><form:input class="input" path="Id" readonly="true"/></div>
		...
		<div class="form"><b>Picture Name*&nbsp;&nbsp;</b><form:input class="input" path="imageName" readonly="true"/></div>
		<div id="btn"><input id="btnInput" style="color:white;background-color: blue;"type="submit" value="Update"/></div>		
	</form:form>
</div>
